    ...
    private void Start(object sender, EventArgs e)
    {
        ...
        else if (_jellyfinServerProcess is null)
        {
            try
            {
                ...
                jellyfinServerProcess.StartInfo.Arguments = "--datadir \"" + _dataFolder + "\" --ffmpeg \"" + Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "scoop", "apps", "jellyfin-ffmpeg", "current", "ffmpeg.exe") + "\"";
